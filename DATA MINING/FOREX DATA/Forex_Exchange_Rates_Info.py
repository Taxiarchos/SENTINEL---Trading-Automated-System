...
def Forex_Rates_List_Gen(ticker_list):  #Ticker_list must be a list of currencies' ticker codes, ex. 'EURUSD' 
    ...
    return historical_price_list               #For example Stock_List_Gen(['EURUSD']) RICORDA CHE L'ARGOMENTO ticker_list E' UNA
